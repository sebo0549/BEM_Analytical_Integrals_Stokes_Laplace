function [Ires_ij,Ires_1r]=Calculate_Integrals_Stokes_Flow_Triangles_Centroid(P,M_Centroid,Con)
% Author: Sebastian Bohm (sebastian.bohm@tu-ilmenau.de)
% Date: 07-12-2023
% License: MIT License

% shift origin to the incenters
x1=P(Con(:,1),:)-M_Centroid;
x2=P(Con(:,2),:)-M_Centroid;
x3=P(Con(:,3),:)-M_Centroid;

% calculate incircle radius and all angles
...
[Lq3,phi5,phi6,q3,X3]=Calculate_Intersection_Points_and_Angles(x3,x1);
