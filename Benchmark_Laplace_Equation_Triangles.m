function Benchmark_Laplace_Equation_Triangles
...
for n=1:Nbenchmark
    tic
    Calculate_Integrals_Laplace_Triangles_Incenter(P,M_Incenter,Con);
    tn_Incenter(n)=toc;

    tic
    Calculate_Integrals_Laplace_Triangles_Centroid(P,M_Centroid,Con);
    tn_Centroid(n)=toc;

    tic
    Calculate_Integrals_Laplace_Triangles_Vertices(P,Con);
    tn_Vertices(n)=toc;
